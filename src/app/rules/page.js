...
const page = async () => {
  ...
  return (
    <>
      ...
      <div   dir="rtl"
  className="text-black text-right max-w-[1222px] w-full px-[15px] mr-auto mb-16 ml-auto" data-aos="fade-up">
        ...
        <p className="mb-5 text-justify text-gray-600">تلفن تماس و فکس: 66726563 – 021</p>
      </div>
      <Footer />
    </>
  );
